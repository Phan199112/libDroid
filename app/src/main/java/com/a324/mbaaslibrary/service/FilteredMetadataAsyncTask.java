...
/**
 * Created by kevinfischer on 4/4/18.
 */

public class FilteredMetadataAsyncTask extends AsyncTask<String, Integer, String> {

    private Context mContext;
    private AsyncStringResult mCallback;
    private Activity mActivity;

    public FilteredMetadataAsyncTask(Context context, Activity activity, AsyncStringResult callback){
        mContext = context;
        mActivity = activity;
        mCallback = callback;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String filter = params[3];
            String url = Keys.KEY_FITLER_META + appName;
            JSONObject requestBody = new JSONObject(filter);
