...
public class EmailAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    /**
     * Send email data to the server, where it will be sent out for the user
     * @param context The application Context
     * @param jsonObject The data you want to send in JSON format
     */
    public EmailAsyncTask(Context context, JSONObject jsonObject) {
