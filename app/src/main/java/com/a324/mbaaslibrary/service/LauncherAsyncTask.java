...
public class LauncherAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    public LauncherAsyncTask(Context context, JSONObject jsonObject, AsyncJsonResult callback) {
